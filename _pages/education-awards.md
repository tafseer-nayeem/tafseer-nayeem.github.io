...
<div class="cv-card">
  ...
  <div>
    ...
    <div class="meta">
      <span class="meta-row"><span class="meta-label">Thesis:</span><a href="/files/MSc_Thesis.pdf">Methods of Sentence Extraction, Abstraction, and Ordering for Automatic Text Summarization</a></span>
      <span class="meta-row"><span class="meta-label">Presentation:</span><a href="/files/MSc_Thesis_Presenation.pdf">slides</a></span>
...
<div class="awards-grid">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/vis.webp" alt="IEEE VIS logo" loading="lazy" decoding="async">
    </div>
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/emnlp.webp" alt="EMNLP logo" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/coling2018.webp" alt="COLING logo" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
...
<div class="awards-grid">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/huawei-logo.webp" alt="Huawei Fellowship" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/uofa.webp" alt="UofA icon" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/uofl.webp" alt="UofL icon" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/iut.webp" alt="IUT-OIC icon" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
...
<div class="awards-grid">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/uofa-cs.webp" alt="UofA icon" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/sigir.webp" alt="SIGIR icon" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/gsa.webp" alt="GSA icon" loading="lazy" decoding="async">
    </div>
    <div class="award-body">

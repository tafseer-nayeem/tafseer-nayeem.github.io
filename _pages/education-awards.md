...
<div class="awards-grid">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/vis.png" alt="IEEE VIS logo" loading="lazy" decoding="async">
    </div>
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/emnlp.png" alt="EMNLP logo" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
...
<div class="awards-grid">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/huawei-logo.png" alt="Huawei Fellowship" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/uofa.png" alt="UofA icon" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
  ...
  <article class="award-card">
    <div class="award-thumb">
      <img src="/images/awards/uofl.png" alt="UofL icon" loading="lazy" decoding="async">
    </div>
    <div class="award-body">
